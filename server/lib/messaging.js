...
const MESSAGE_CLIENT_TYPE = "client:type"
const MESSAGE_PLAYER_CONNECTED = "player:connected"
const MESSAGE_PLAYER_DISCONNECTED = "player:disconnected"
const MESSAGE_PLAYER_STATE_CHANGED = "player:state-changed"
const MESSAGE_REQUEST_TOKEN = "player:request-token"
const MESSAGE_TOKEN = "player:token"
const MESSAGE_UNAUTHORIZED = "player:unauthorized"
...
async function storeTokens(tokens) {
    ...
    database.set(database.DOCUMENT_TOKENS, {
        ...tokens,
...
module.exports.initialize = async () => {
    tokens = database.get(database.DOCUMENT_TOKENS)
}
